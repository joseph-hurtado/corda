...
class InteractiveShellTest {
    ...
    class DummyFSM(val logic: FlowA) : FlowStateMachine<Any?> {
        override fun getFlowContext(otherParty: Party, flowUsedForSessions: FlowLogic<*>): FlowContext {
        ...
        override val resultFuture: ListenableFuture<Any?> get() = throw UnsupportedOperationException()
