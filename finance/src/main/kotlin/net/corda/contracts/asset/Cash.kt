...
class Cash : OnLedgerAsset<Currency, Cash.Commands, Cash.State>() {
    ...
    companion object {
         ...
         * @param services The service hub to allow acces to the database session
         * @param amount The amount of currency desired (ignoring issues, but specifying the currency)
         * @param onlyFromIssuerParties If null the operation ignores the specifics of the issuer,
         ...
         * @param withIssuerRefs If not null the specific set of issuer references to match against.
